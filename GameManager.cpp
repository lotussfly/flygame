...
bool CGameManager::init()
{
	...
	do{
		...
		pBack->setCallback(CC_CALLBACK_1(CGameManager::back,this));
		//pBack->setCallback(menu_selector(CGameManager::back));
	    ...
	    touchListener->onTouchBegan = CC_CALLBACK_2(CPlayerSprite::onTouchBegan, m_pPlayer);
	    touchListener->onTouchMoved = CC_CALLBACK_2(CPlayerSprite::onTouchMoved, m_pPlayer);
	    _eventDispatcher->addEventListenerWithSceneGraphPriority(touchListener,m_pPlayer);
	}
	while(0);
